<div class="leftpanel fix_we" id="canvasFrame">
  <div class="full_frm_<?=strtolower(str_replace(" ", "_", $option_name));?>" id="outerDiv">
      ...
      <div class="rightpanel">
       ...
       <div class="listdiv"><?php echo $size = (!empty($_SESSION['cartVal']['size']))?$_SESSION['cartVal']['size']:''; ?>
       ...
       ?>
		  <label>Your Price : </label><span class="totalPrice">$<?php echo number_format($total_price,2); ?></span>          
