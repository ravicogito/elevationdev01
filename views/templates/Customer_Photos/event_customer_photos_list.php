...
<div class="row sercphto">
<input type="hidden" id="cust_location" value="<?php echo $location_id ;?>">
<?php
if(!empty($locationDetails)){

	  $i=1;
	$count	= count($eventDetails);
...
?>
<div class="noimge">
<h3>You have no event on this location.</h3>
<span>To see your photos of your location.Please <a class="book_submit" href="<?php echo base_url(); ?>CustomerPhotos/customerEventPhotoList/">click here</a>
</div>
<?php 	
}
...
function addMore(){
	...
	$.ajax({
	    type: 'POST',
	    url: '<?php echo base_url();?>CustomerPhotos/customerEventPhoto/' + lid +'/'+ start,	    
		dataType:"HTML",
