...
<option value="all" <?php if($orders_status=='all'){ echo "selected"; }?>>All</option>
<option value="0" <?php if($orders_status=='0'){ echo "selected"; }?>>Cancel</option>
<option value="1" <?php if($orders_status=='1'){ echo "selected"; }?>>New</option>
<option value="2" <?php if($orders_status=='2'){ echo "selected"; }?>>Processing</option>
<option value="3" <?php if($orders_status=='3'){ echo "selected"; }?>>Shipped</option>
<option value="4" <?php if($orders_status=='4'){ echo "selected"; }?>>Backorderd</option>
</select>
</div>   
</section>    
