...
(function($){
  ...
  <div class="content-wrapper">
    ...
    <div class="box-tools pull-right" style="margin-bottom:10px">
		  <a class="btn btn-block btn-default" href="<?php echo base_url().'User/addUser/'; ?>"><i class="fa fa-plus-square"></i>&nbsp;Add New User</a>
        ...
        <div class="col-md-12">
			...
			<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			  ...
			  <tbody>
				...
				<tr>
				  <td><?php echo $i; ?></td>
				  <td><?php echo $user_list['name']; ?>
				  <td><?php echo $user_list['username']; ?>
				  <td><?php echo $user_list['email']; ?>
				  <td width="12%"><a href="<?php echo base_url().'User/editUser/'.$user_list['user_id']; ?>" class="label label-success">Edit</a></td>
			   ...
			   <?php $i++; } } else { ?>
				...
				<tr>
					 <td colspan="5" align="center"> There is no User Added.</td>
				</tr>
